...
- Every time the user asks for app animation, motion polish, transitions, or micro-interactions
...
Capture only the context that changes the solution:

- Stack and platform: Flutter, SwiftUI, Compose, React Native, web, or mixed
- Surface: screen transition, overlay, list, form, drag, loading, feedback, or gesture
- Tone: calm, direct, playful, premium, or utility-first
...
Infer and confirm stable preferences:

- Conservative vs expressive motion language
- Short vs medium duration bias
